...
const OnboardingReview: FC<OnboardingReviewProps> = () =>  {
    ...
    return (
        <>
            ...
            <div className='form-container' style={{width:900, height: 368, flexDirection: 'row', justifyContent: 'space-evenly'}}>
                <div className='column' style={{width: '33%', justifyContent: 'space-evenly'}}>
                ...
                <div className='column' style={{width: '33%', justifyContent: 'flex-start',  gap: 11, overflowY: 'scroll'}}>
